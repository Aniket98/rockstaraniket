...
But then why the message says connected to idle instance? If the instance was not running, then why is says connected to idle instance? What does idle mean here?
